...
| P8 | `PARTIAL` | Resolver lineage-first dan koridor per pasangan historis selesai; incremental reflow, dense-partnership stress yang lebih luas, dan tablet performance gate masih terbuka |
...
|---|---|---|---|---|
| 2026-08-03 | Post-Fase 4 / P5, P8 | Menjadikan parent-child sebagai sumber level generasi, melepas `DIVORCED`/`WIDOWED` dari komponen placement keras, menambatkan blok anak ke cincin pasangan biologis, dan menolak pasangan beda generasi pada backend | Backend 39 unit + 22 E2E dan build lulus; Android 144 unit, lint, debug APK, dan 40/40 connected instrumentation lulus; hubungan salah Nn–Solihin di Ummah Bugo dihapus melalui mutation tersinkron; APK pilot build 5 dipasang dan cold-launch tanpa crash | Hubungan pasangan boleh menyelaraskan komponen lineage yang benar-benar terpisah, tetapi tidak pernah menimpa level biologis. Instrumentation mereset sesi/data lokal sehingga smoke data cloud menunggu pemilihan ulang akun Google; publish source/Cloud Run tetap gate terpisah sampai diotorisasi |
